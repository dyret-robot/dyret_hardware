...
/**
 * This file contains header definitions for the interactions with
 * `dynamixel_sdk`
 */
...
namespace dynamixel_wrapper {
	...
	std::ostream& operator<<(std::ostream& os, const ComError& e) {
		switch(e) {
			case ComError::Success: os << "communication success"; break;
			case ComError::PortBusy: os << "USB port busy"; break;
			case ComError::TxFail: os << "failed to transmit instruction packet"; break;
			case ComError::RxFail: os << "failed to get status packet"; break;
			case ComError::TxError: os << "incorrect instruction packet"; break;
			case ComError::RxWaiting: os << "currently receiving status packet"; break;
			case ComError::RxTimeout: os << "receiving status packet timeout"; break;
			case ComError::RxCorrupt: os << "received incorrect status packet"; break;
			case ComError::NotAvailable: os << "communication not available"; break;
		}
		return os;
	}
	...
	class Wrapper {
		public:
			...
			ComError enable(bool);
			// Enable or disable torque for specified servo
			ComError enable(uint8_t, bool);
